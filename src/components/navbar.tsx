        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex-shrink-0">
            <h1 className="font-orbitron text-xl font-bold text-white">
              PLA<span className="text-red-500">ip</span>
            </h1>
          </div>
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-8">
              ...
              <a href="#order" className="font-geist text-red-400 hover:text-red-300 transition-colors duration-200 font-semibold">
                Заказать
              </a>
            </div>
          </div>
          ...
          <div className="hidden md:block">
            <a href="#order">
              <Button className="bg-red-500 hover:bg-red-600 text-white font-geist border-0">Заказать печать</Button>
            </a>
          </div>
        ...
        {isOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 bg-black/98 border-t border-red-500/20">
              ...
              <a
                href="#order"
                className="block px-3 py-2 font-geist text-red-400 hover:text-red-300 transition-colors duration-200 font-semibold"
                onClick={() => setIsOpen(false)}
              >
                Заказать
              </a>
